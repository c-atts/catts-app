...
const ETH_PAYMENTS_LATEST_BLOCK_DEFAULT: u32 = 5751389;
...
thread_local! {
    ...
    static ETH_PAYMENT_CONTRACT: Rc<Contract> = Rc::new(include_abi!("../../payments/abi.json"));
    static ETH_EAS_CONTRACT: Rc<Contract> = Rc::new(include_abi!("../../eas/EAS.json"));
